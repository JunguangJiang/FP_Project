...
---- my own test ----
tCase1 = Program [] $ ECase (EIntLit 3) [(PIntLit 2, EIntLit 3), (PVar "x", EVar "x")]
test_case_type1 = assertEqual (Just TInt) (EvalType.evalType tCase1)

tCase2 = Program [] $ ECase (EIntLit 3) [(PIntLit 2, EBoolLit True), (PVar "x", EVar "x")]
test_case_type2 = assertEqual Nothing (EvalType.evalType tCase2)

tCase3 = Program [] $ ECase (EIntLit 3) [ 
  (PIntLit 2, EIntLit 3), 
  (PIntLit 5, EIntLit 6),
  (PVar "x", EAdd (EVar "x") (EIntLit 4) ) 
  ]
test_case_type3 = assertEqual (Just TInt) (EvalType.evalType tCase3)
...
adt2 = ADT "T2" [
  ("con2_1", [TData "T1", TData "T1", TChar]),
  ("con2_2", [TData "T2", TBool]),
  ("con2_3", [TInt])
  ]

t1_1 = EData "con1_1" [EIntLit 3, EBoolLit True]
t1_2 = EData "con1_2" [EIntLit 3, EBoolLit True]
t2_1 = EData "con2_1" [t1_1, t1_1, ECharLit 'c']
t2_2 = EData "con2_2" [t2_1, EBoolLit True]

pattern1 = [ 
  (PData "con1_1" [PIntLit 3, PVar "b"], EVar "b"), 
  (PData "con1_2" [PVar "x"], EEq (EVar "x") (EIntLit 4)),
  (PData "con1_3" [PVar "b"], EVar "b"),
  (PVar "x", EBoolLit False)
  ]

pattern2 = [
  (PData "con2_1" [PData "con1_2" [PVar "x"], PData "con1_3" [PVar "b"], PVar "c"], EAnd (EGt (EVar "x") (EIntLit 4)) (EAnd (EVar "b") (EEq (EVar "c") (ECharLit 'c')))),
   (PData "con2_3" [PIntLit 4], EBoolLit True)
  ]

failpattern1 = [
    (PData "con2_1" [PData "con1_2" [PVar "x"], PData "con1_3" [PVar "b"], PVar "c"], EAnd (EGt (EVar "x") (EIntLit 4)) (EAnd (EVar "b") (EEq (EVar "c") (ECharLit 'c')))),
     (PData "con2_3" [PIntLit 4], EIntLit 4)
    ]

tCase4 = Program [adt1] $ ECase t1_1 pattern1
tCase5 = Program [adt2] $ ECase t1_2 pattern1
tCase6 = Program [adt1, adt2] $ ECase t2_1 pattern2
tCase7 = Program [adt1, adt2] $ ECase t2_2 pattern2
tCase8 = Program [adt1, adt2] $ ECase t2_2 failpattern1

tADT1 = Program [adt1] $ t1_1
tADT2_1 = Program [adt1, adt2] $ t2_1
tADT2_2 = Program [adt1, adt2] $ t2_2
tADT2_3 = Program [adt1, adt2] $ EData "con2_3" [EIntLit 4]

test_case_case1 = assertEqual (Just TBool) (EvalType.evalType tCase4)
test_case_case2 = assertEqual Nothing (EvalType.evalType tCase5)
test_case_case3 = assertEqual (Just TBool) (EvalType.evalType tCase6)
test_case_case4 = assertEqual (Just TBool) (EvalType.evalType tCase7)
test_case_case5 = assertEqual Nothing (EvalType.evalType tCase8)